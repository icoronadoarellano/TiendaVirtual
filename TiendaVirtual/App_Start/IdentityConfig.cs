...
namespace TiendaVirtual
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            MailMessage email = new MailMessage {
                From = new MailAddress("noreply@TiendaVirtual.com",
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            {
                MessageFormat = "Su código de TiendaVirtual es {0}"
            });
            manager.RegisterTwoFactorProvider("Código de correo electrónico", new EmailTokenProvider<ApplicationUser>
            {
                Subject = "Código de TiendaVirtual",
                BodyFormat = "Su código de TiendaVirtual es {0}"
            });
