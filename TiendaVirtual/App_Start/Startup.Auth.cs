    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                {
                    // Permite a la aplicación validar la marca de TiendaVirtual cuando el usuario inicia sesión.
                    // Es una característica de TiendaVirtual que se usa cuando se cambia una contraseña o se agrega un inicio de sesión externo a la cuenta.  
